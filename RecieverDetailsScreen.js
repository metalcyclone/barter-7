...
addNotification=()=>{
    var message = this.state.userName + " has shown interest in exchanging the book"
      ...
      <View style={styles.container}>
        <View style={{flex:0.1}}>
          <Header
            ...
            centerComponent={{ text:"Exchange Things", style: { color: '#90A5A9', fontSize:20,fontWeight:"bold", } }}
